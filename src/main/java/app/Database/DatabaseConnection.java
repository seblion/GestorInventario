...
public class DatabaseConnection {
    ...
    /**
     * Método que conecta el Driver JDBC y luego establece una conexión con el
     * objeto Connection usando la URL configurada para SQL Server.
     *
     * @throws Exception
     */
    ...
    /**
     * Método que verifica si mis Objetos de Conexión, Sentencia y Resultado tienen
     * valores asignados. Si es así, se los devuelve a un estado 'null'
     * 
     * @throws Exception
     */
    ...
    /**
     * Método que se conecta a la base, prepara el Objeto Statement y ejecuta con un
     * método la query pasada como argumento
     * 
     * @param sql Sentencia query nativa de tipo INSERT, UPDATE, DELETE que no
     *            devuelve ninguna tabla
     * @throws Exception
     */
    ...
    /**
     * Método que se conecta a la base, prepara el Objeto Statement y luego guarda
     * en el Objeto ResultSet las tablas devueltas al ejectuar la sentencia query
     * que fue pasada como argumento
     * 
     * @param sql Sentencia query nativa de tipo consulta SELECT que devuelva una
     *            tabla
     * @throws Exception
     */
